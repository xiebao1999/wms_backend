...
public:
	...
	// Access:    public 
	// Returns:   HPDF_Font
	// Qualifier: 获取PDF内置PBase14字体句柄，更多参考：https://github.com/libharu/libharu/wiki/Fonts
	...
	// Access:    public 
	// Returns:   HPDF_Font
	// Qualifier: 获取Haru内置中文繁体字体句柄，目前只支持一种：MingLiU
	// Parameter: bool isVertical 是否纵向显示
	//************************************
